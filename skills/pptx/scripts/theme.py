...
TYPOGRAPHY = {
    "clean": {
        "font-zh": '"Microsoft YaHei","Noto Sans SC","PingFang SC",Arial,sans-serif',
        "font-ui": '"Microsoft YaHei","Segoe UI",Arial,sans-serif',
    },
    "editorial": {
...
DIRECTIONS = {
    "fresh-default": {
        ...
        "recommended": {"palette": "yellow", "typography": "clean", "shape": "soft"},
    },
    "editorial-story": {
        "label": "编辑叙事",
...
def validate_theme(value: object) -> dict[str, str]:
    ...
    result = {
        "palette": str(value.get("palette") or "yellow"),
